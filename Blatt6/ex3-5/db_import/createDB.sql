...
-- Name: webtech20gallery; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE webtech20gallery WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';


ALTER DATABASE webtech20gallery OWNER TO postgres;

\connect webtech20gallery
...
-- Dependencies: 2835
-- Name: DATABASE webtech20gallery; Type: ACL; Schema: -; Owner: postgres
--

CREATE USER "gallery_root" with password 'password';
GRANT ALL ON DATABASE webtech20gallery TO gallery_root;
